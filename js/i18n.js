...
const translations = {
  th: {
    ...
    homeContact: "ติดต่อจองหมอที่ Line OA: @ploymt (มี @ ด้วยนะคะ) หรือ โทร 085-3955458 คุณพลอย",
    // Index hero (emerald design)
    brandLocation: "เมืองทองธานี",
    heroTitle: "น้องหมอของร้าน",
    heroDesc: "ดูสถานะน้องหมอแบบเรียลไทม์ ว่าง / ไม่ว่าง อัปเดตตลอดวัน",
    ctaOpenChat: "Open Chat ร้าน",
    ctaBookLine: "จองผ่าน Line OA",
    ctaAskBookLine: "สอบถาม/จองผ่าน Line OA",
    ctaCall: "โทรจองหมอ",
    staffCount: "คน",
    ...
    realCustomerReviews: "รีวิวจากลูกค้าจริง",
    reviewCount: "รีวิว",
    photoGallery: "แกลเลอรี",
    backToList: "← กลับไปหน้ารวมหมอ",
    backToHomeShort: "← กลับ",
    languages: "ภาษา",
    voicePlay: "ฟังเสียงน้อง",
    voicePause: "หยุด",
    coursePricing: "คอร์สและราคา",
    courseMinutes: "นาที",
    bookThisTherapist: "จอง",
    etaAvailable: "คาดว่าว่าง",
    etaMins: "อีกประมาณ",
    minutes: "นาที",
    realCustomer: "ลูกค้าจริง",
    measurementsHeading: "สัดส่วน",
    measurementsHeadingFull: "สัดส่วน (อก เอว สะโพก)",
    heightHeading: "ส่วนสูง",
    ageHeading: "อายุ",
    yearsOld: "ปี",
  ...
  en: {
    ...
    homeContact: "Book via LINE OA: @ploymt or call 085-395-5458 (Khun Ploy)",
    // Index hero (emerald design)
    brandLocation: "Mueang Thong Thani",
    heroTitle: "Our Therapists",
    heroDesc: "Real-time therapist availability, updated throughout the day",
    ctaOpenChat: "Shop Open Chat",
    ctaBookLine: "Book via Line OA",
    ctaAskBookLine: "Ask / Book via Line OA",
    ...
    realCustomerReviews: "Reviews from Real Customers",
    reviewCount: "reviews",
    ...
    courseMinutes: "min",
    bookThisTherapist: "Book",
    etaAvailable: "Available at",
    etaMins: "in about",
    minutes: "min",
    realCustomer: "Verified",
    measurementsHeading: "Measurements",
    measurementsHeadingFull: "Measurements (Bust · Waist · Hip)",
